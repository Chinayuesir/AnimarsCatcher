...
namespace AnimarsCatcher
{
    public class PICKER_Ani : MonoBehaviour
    {
        ...
        private bool mCanGetCarryObj;
        private float mCheckRadius = 3f;
        ...
        {
            mCanGetCarryObj = true;
        }

        public void StopCarry()
        {
            mCanGetCarryObj = false;
            mCarryObj = null;
        }
        ...
        private void GetCarryObj()
        {
            ...
            Physics.OverlapSphereNonAlloc(transform.position, mCheckRadius, results);
